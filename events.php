		...
		<h1>Dates à venir</h1>
 		...
 		<div class="event incoming">
 			...
 			<section class="detail">
 				...
 				<h2>Tanz+Folk!</h2>
 				<a href="https://goo.gl/maps/T2FSZN54sGE2" target="_blank" title="Plan vers le bal de Tanz+Folk! avec les conteuses de pas" class="address">Hardenbergsaal im Hardenberghaus, Laerheidestraße 26, 44799 Bochum, Germany</a>
 			</section>
 			<section id="eventLinks">
 				<ul>
 					...
 					<li><a href="https://www.facebook.com/events/656904741318432/" target="_blank" title="Ball mit Les Conteuses de Pas, Wüdneks Erben und As Seirbhís" class="eventIcon fab fa-facebook-f"></a></li>
 				</ul>
 			</section>
 		</div>
 		<div class="clear"></div>
 		...
 		<div class="event incoming">
 			...
 			<section class="detail">
 				<ul class="event">
 					<li class="typeEvent">Balade chantée</li>
 					<li class="hourEvent">19:00</li>
 				</ul>
 				<h2>Balade chantée : fête de la musique</h2>
 				<a href="https://goo.gl/maps/qoxEdnxqes22" target="_blank" title="Plan vers le bal de Tanz+Folk! avec les conteuses de pas" class="address">Départ : Parc place des Vosges, 75004, Paris</a>
 			</section>
 			<section id="eventLinks">
 				<ul>
 					<li><a href="https://www.carambal.fr/" target="_blank" title="Site de l'association Carambal" class="eventIcon fas fa-external-link-square-alt"></a></li>
 					<li><a href="https://goo.gl/maps/qoxEdnxqes22" target="_blank" title="Plan vers le bal de Tanz+Folk! avec les conteuses de pas" class="eventIcon fas fa-map-marker"></a></li>
 					<li><a href="https://www.facebook.com/events/177730676273902/" target="_blank" title="Balade chantée dans Paris pour la fête de la musique avec Carambal et les Conteuses de Pas" class="eventIcon fab fa-facebook-f"></a></li>
 				</ul>
 			</section>
 		</div>
 		<div class="clear"></div>
