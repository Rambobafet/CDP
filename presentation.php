...
$pageDescription = 'Formées en groupe pour l’occasion d’une scène ouverte, les Conteuses de Pas se sont tant amusées à faire de la musique ensemble qu’elles continuent depuis sur cette première lancée avec beaucoup d’enthousiasme et de bonheur.';
	...
	<div id="global-container" class="presentation">
		...
		<h1>Présentation</h1>
 		...
 		<section id="group">
 			...
 			<p>Formées en groupe pour l’occasion d’une scène ouverte, les Conteuses de Pas se sont tant amusées à faire de la musique ensemble qu’elles continuent depuis sur cette première lancée avec beaucoup d’enthousiasme et de bonheur.</p>
